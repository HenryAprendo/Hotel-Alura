...
public class Login extends JFrame {
	...
	private boolean contrasenaEsValido; 
	...
	public Login() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String contrasena = "alura";
				String nombreUsuario = "Henry";	
				
				String inputUsuario = String.valueOf(txtUsuario.getText());				
				String contrasenaUsuario = String.valueOf(txtContrasena.getPassword());
				
				usuarioEsValido = inputUsuario.equals(nombreUsuario);
				contrasenaEsValido = contrasenaUsuario.equals(contrasena);
				
				if (inputUsuario.isEmpty() || contrasenaUsuario.isEmpty()) {
					JOptionPane.showMessageDialog(btnLogin, "Los campos usuario y contraseña son requeridos");
					return;
				}
				
				if (usuarioEsValido && contrasenaEsValido) {
	...
	private void noEsValido() {
		if (!usuarioEsValido && !contrasenaEsValido) {
			JOptionPane.showMessageDialog(txtContrasena,"Usuario y contraseña invalidos");
		}
		else if (!usuarioEsValido) {
			JOptionPane.showMessageDialog(txtContrasena,"Usuario invalido");
		}
		else {
			JOptionPane.showMessageDialog(txtContrasena,"Contraseña invalida");
		}
	}
