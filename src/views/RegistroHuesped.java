...
public class RegistroHuesped extends JFrame {
	...
	public void guardar() {
		...
		if (txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtFechaN.getDate() == null) {
			JOptionPane.showMessageDialog(this, "Diligencie todos los campos del formulario");
			return;
		}
		else {		
